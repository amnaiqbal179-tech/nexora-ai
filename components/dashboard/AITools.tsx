...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Explore new concepts and transform ideas into possibilities.",
    label: "Explore",
  },
];
  ...
  const handleGenerate = () => {
    ...
    setTimeout(() => {
      if (activeTool === "writer") {
        setResult(
          `AI Writer created a polished response based on: "${prompt}"`
        );
      }

      if (activeTool === "analyst") {
        setResult(
          `Data Analyst identified useful patterns and actionable insights from: "${prompt}"`
        );
      }

      if (activeTool === "ideas") {
        setResult(
          `Idea Generator discovered several creative possibilities around: "${prompt}"`
        );
      }
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            Powerful AI tools designed to help you think,
            create and execute without leaving your workspace.
          </p>
        </div>
          ...
          {tools.map((tool, index) => {
            ...
            return (
              <button
                ...
                `}
                style={{
                  animationDelay: `${450 + index * 120}ms`,
                }}
              >
                {/* =================================================
                    ACTIVE INDICATOR
          ...
          {selectedTool && (
            <div className="relative p-5 sm:p-7">
              ...
              <div className="relative">
                ...
                <p className="mt-4 max-w-2xl text-xs leading-6 text-white/30">
                ...
                <div className="mt-5">
                  <label
                    ...
                    "
                  >
                    {selectedTool.id === "writer"
                      ? "What should I write?"
                      : selectedTool.id === "analyst"
                      ? "What should I analyze?"
                      : "What should I generate ideas for?"}
                  </label>
                  ...
                  <div className="mt-2 flex flex-col gap-2 sm:flex-row">
                    <input
                      ...
                      placeholder={
                        selectedTool.id === "writer"
                          ? "e.g. Write a product launch announcement..."
                          : selectedTool.id === "analyst"
                          ? "e.g. Analyze my weekly productivity..."
                          : "e.g. Generate ideas for my next project..."
                      }
                      className="
                        min-w-0
                        flex-1
